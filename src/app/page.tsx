...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/multiethnic-volunteers-cooking-needy_482257-84793.jpg",
          alt: "Happy diner",
        },
        {
          src: "http://img.b2bpic.net/free-photo/crop-cut-tomatoes-grated-cheese_132075-8848.jpg",
          alt: "Satisfied traveler",
        },
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/female-hand-holding-uncooked-chicken-grilling_23-2147840865.jpg",
          alt: "Friendly local",
        },
        {
      ...
      bulletPoints={[
        {
          ...
          description: "Conveniently located on SH1, the perfect stopover between Auckland and Northland.",
        },
        {
          title: "Versatile Dining",
          description: "Casual restaurant and bar with a wide selection of grill classics, pizzas, and drinks.",
        },
        {
      ...
      features={[
        {
          ...
          description: "Steaks, burgers, and classic Kiwi grills cooked to perfection.",
          bentoComponent: "reveal-icon",
          icon: Flame,
          imageSrc: "http://img.b2bpic.net/free-photo/ice-cold-fruit-aroma-drink-tray_23-2148602830.jpg",
  ...
  <div id="stay" data-section="stay">
      ...
      products={[
        ...
        },
        {
          ...
          name: "Family Room",
          price: "$210/night",
          imageSrc: "http://img.b2bpic.net/free-photo/cutting-board-with-biscuits-near-scarf-kettle_23-2147963568.jpg",
        },
        {
          id: "3",
          name: "Double Room",
        ...
        },
        {
          ...
          name: "Single Room",
          price: "$130/night",
          imageSrc: "http://img.b2bpic.net/free-photo/decoration-bedroom_74190-5751.jpg",
        },
        {
          id: "5",
          name: "Twin Suite",
        ...
        },
        {
          ...
          price: "$170/night",
          imageSrc: "http://img.b2bpic.net/free-photo/still-life-cozy-room-with-beautiful-handmade-ceramic-cup_169016-3810.jpg",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/medium-shot-woman-with-delicious-hot-dog_23-2150347894.jpg",
          alt: "Diner 1",
        },
        {
